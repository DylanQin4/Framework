...
<body>
    <div class="container mt-4">
        ...
        <form action="${pageContext.request.contextPath}/flights/add" method="post" id="flightForm" class="needs-validation" novalidate>
            <!-- Numéro de vol -->
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" class="form-control" id="departureTime" name="departureTime" 
                           value="${defaultDepartureTime}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" class="form-control" id="arrivalTime" name="arrivalTime" 
                           value="${defaultArrivalTime}" required>
                    <div class="invalid-feedback">Veuillez saisir une date et heure d'arrivée.</div>
                </div>
            </div>
            
            <!-- Délais de réservation et annulation -->
            <div class="row mb-3">
                <div class="col-md-3">
                    <label for="reservationCutoffHours" class="form-label">Délai de réservation (heures)</label>
                    <input type="number" class="form-control" id="reservationCutoffHours" name="reservationCutoffHours" min="0" 
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="cancellationCutoffHours" name="cancellationCutoffHours" min="0" 
                ...
                document.getElementById("flightForm").addEventListener("submit", function (event) {
                    ...
                    classes.forEach(clazz => {
                        passengerTypes.forEach(passengerType => {
                            ...
                            console.log("Processing class:", classId, "type:", passengerTypeId);
